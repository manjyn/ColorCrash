...
{
    [CustomPropertyDrawer(typeof(ProjectileDataRecord))]
    public class ProjectileDataRecordDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var idProp = property.FindPropertyRelative("projectileId");
